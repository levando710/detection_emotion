...
emotions = {
    ...
    4: {"emotion": "Neutral", "color": (108, 72, 200)}, 
    5: {"emotion": "Sad", "color": (164, 93, 23)},
    6: {"emotion": "Surprise", "color": (218, 229, 97)} 
}
...
emotionModelPath = r'D:\face-classification\my_emotion_model_pro.h5' 
...
while True:
    ...
    for rect in rects:
        ...
        # Tránh lỗi văng app khi mặt quá sát camera (index out of bounds)
        ...
        if (emotion_probability > 0.36):
            ...
            cv2.rectangle(frame, (x, y + h), (x + 110, y + h + 20), color, -1)
            cv2.putText(frame, emotions[emotion_label_arg]['emotion'],
                        (x + 5, y + h + 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5,
